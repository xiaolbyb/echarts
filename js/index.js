...
(function() {
  //实例化对象
  let myChart = echarts.init(document.querySelector('.bar-two .chart'));
  //指定配置项和数据
...
(function() {
  //实例化对象
  let myChart = echarts.init(document.querySelector('.line-two .chart'));
  //指定配置项和数据
  let option = {
    tooltip: {
        trigger: 'axis'
...
(function() {
  //实例化对象
  let myChart = echarts.init(document.querySelector('.pie-two .chart'));
  //指定配置项和数据
  let option = {
...
[['西安', XAData], ['西宁', XNData], ['银川', YCData]].forEach(function (item, i) {  
  ...
  var option = {
    ...
    geo: {
        ...
        itemStyle: {
          normal: {
              areaColor: 'rgba(20, 41, 87,0.8)',  //省份的颜色
              borderColor: '#195BB9',
              borderWidth: 1,
          },
          emphasis: {
